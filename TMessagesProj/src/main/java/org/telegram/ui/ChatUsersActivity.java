            ...
            switch (holder.getItemViewType()) {
                ...
                case VIEW_TYPE_INNER_CHECK:
                    ...
                    if (position == sendMediaPhotosRow) {
                        ...
                        checkBoxCell.setText(LocaleController.getString("SendMediaPermissionStickers", R.string.SendMediaPermissionStickers), "", !defaultBannedRights.send_stickers, true, animated);
                    } else if (position == sendMediaMusicRow) {

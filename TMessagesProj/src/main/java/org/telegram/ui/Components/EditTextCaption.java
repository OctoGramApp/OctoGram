...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (hasSelection()) {
            ...
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_mention, LocaleController.getString(R.string.Mention)));
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(R.id.menu_format_code, LocaleController.getString(R.string.CodeFormat)));
        }
    }

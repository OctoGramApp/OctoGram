...
class SessionIconUtils {
    ...
    private fun getSessionTypeObject(authorization: TLRPC.TL_authorization): SessionType {
        ...
        val platform =
            safeLowerCase(authorization.platform).ifEmpty { safeLowerCase(authorization.system_version) }
        ...
        return when {
            ...
            platform.contains("ubuntu") || systemVersion.contains("ubuntu") || systemVersion.contains(
                "linux"
            ) -> SessionType.LINUX
    ...
    fun setDeviceAttributes(session: TLRPC.TL_authorization): DeviceAttributes {
        ...
        return when (sessionType) {
            SessionType.SAFARI -> DeviceAttributes(
                R.drawable.device_web_safari,
                Theme.key_avatar_backgroundPink,
                Theme.key_avatar_background2Pink,
                R.raw.safari_30
            )

            SessionType.EDGE -> DeviceAttributes(
                R.drawable.device_web_edge,
                Theme.key_avatar_backgroundPink,
                Theme.key_avatar_background2Pink,
                R.raw.edge_30
            )

            SessionType.CHROME -> DeviceAttributes(
                R.drawable.device_web_chrome,
                Theme.key_avatar_backgroundPink,
                Theme.key_avatar_background2Pink,
                R.raw.chrome_30
            )

            SessionType.OPERA -> DeviceAttributes(
            ...
            SessionType.FIREFOX -> DeviceAttributes(
            ...
            SessionType.VIVALDI -> DeviceAttributes(
            ...
            SessionType.IPHONE -> DeviceAttributes(
                R.drawable.device_phone_ios,
                Theme.key_avatar_backgroundBlue,
                Theme.key_avatar_background2Blue,
                R.raw.iphone_30
            )

            SessionType.IPAD -> DeviceAttributes(
                R.drawable.device_tablet_ios,
                Theme.key_avatar_backgroundBlue,
                Theme.key_avatar_background2Blue,
                R.raw.ipad_30
            )

            SessionType.WINDOWS -> DeviceAttributes(
                R.drawable.device_desktop_win,
                Theme.key_avatar_backgroundCyan,
                Theme.key_avatar_background2Cyan,
                R.raw.windows_30
            )

            SessionType.MAC -> DeviceAttributes(
                R.drawable.device_desktop_osx,
                Theme.key_avatar_backgroundCyan,
                Theme.key_avatar_background2Cyan,
                R.raw.mac_30
            )

            SessionType.UBUNTU, SessionType.LINUX -> DeviceAttributes(
                R.drawable.device_desktop_other,
                Theme.key_avatar_backgroundCyan,
                Theme.key_avatar_background2Cyan,
                R.raw.linux_30
            )

            SessionType.ANDROID -> DeviceAttributes(
                R.drawable.device_phone_android,
                Theme.key_avatar_backgroundGreen,
                Theme.key_avatar_background2Green,
                R.raw.android_30
            )

            SessionType.ANDROID_TABLET -> DeviceAttributes(
                R.drawable.device_tablet_android,
                Theme.key_avatar_backgroundGreen,
                Theme.key_avatar_background2Green,
                R.raw.android_30
            )
            ...
            SessionType.PREMIUMBOT -> DeviceAttributes(
                R.drawable.filled_star_plus,
                Theme.key_color_yellow,
                Theme.key_color_orange,
                -1
            )

            SessionType.QUESTION -> DeviceAttributes(R.drawable.msg_emoji_question, -1, -1, -1)
            SessionType.TELEGRAMX -> DeviceAttributes(
            ...
            SessionType.OCTOGRAM -> DeviceAttributes(
                R.drawable.baseline_octo_24,
                -1,
                -1,
                -1,
                octoColor,
            ...
            SessionType.API -> DeviceAttributes(
                R.drawable.filled_paid_broadcast,
                Theme.key_avatar_backgroundGreen,
                Theme.key_avatar_background2Green,
                -1
            )

            SessionType.ANONYMOUS -> DeviceAttributes(
                R.drawable.large_hidden,
                Theme.key_avatar_backgroundBlue,
                Theme.key_avatar_background2Blue,
                -1
            )

            SessionType.ADS -> DeviceAttributes(
            ...
            SessionType.KITSUGRAM -> DeviceAttributes(
                R.drawable.kitsugram,
                -1,
                -1,
                -1,
                tgxColor,
            ...
            SessionType.MATERIALGRAM -> DeviceAttributes(
                R.drawable.materialgram,
                -1,
                -1,
                -1,
                materialGramColor,
            ...
            SessionType.SWIFTGRAM -> DeviceAttributes(
                R.drawable.swiftgram,
                -1,
                -1,
                -1,
                swiftGramColor,
            ...
            SessionType.WEARGRAM -> DeviceAttributes(
                R.drawable.weargram,
                Theme.key_avatar_backgroundCyan,
                Theme.key_avatar_background2Cyan,
                -1

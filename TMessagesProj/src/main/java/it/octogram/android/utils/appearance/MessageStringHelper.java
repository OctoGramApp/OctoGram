        ...
        for (CharacterStyle mSpan : mSpans) {
            ...
            if (mSpan instanceof TextStyleSpan) {
                ...
                if ((((TextStyleSpan) mSpan).getStyleFlags() & TextStyleSpan.FLAG_STYLE_URL) > 0) {
                    ...
                    if (url != null && (includeLinks || (!url.equals(urlEntity) && !url.equals(String.format(Locale.US, "http://%s", urlEntity)) && !url.equals(String.format(Locale.US, "https://%s", urlEntity))))) {

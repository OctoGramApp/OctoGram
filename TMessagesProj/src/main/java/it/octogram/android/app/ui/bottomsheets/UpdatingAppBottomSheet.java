...
public class UpdatingAppBottomSheet extends BottomSheet {
    private final LinearProgressView progressView;
    private boolean isDismissingByCall = false;

    public UpdatingAppBottomSheet(Context context, boolean needFocus) {
        ...
        imageView.setStickerNum(StickerUi.NO_SPOILER.getValue());
        ...
        textView.setText(LocaleController.getString(R.string.UpdatesInstallationDoingTitle));
        ...
        textView.setGravity(Gravity.CENTER_HORIZONTAL);
        textView.setText(LocaleController.getString(R.string.UpdatesInstallationDoingDesc));

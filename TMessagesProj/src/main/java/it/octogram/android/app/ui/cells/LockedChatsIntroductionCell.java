...
public class LockedChatsIntroductionCell extends FrameLayout {
    private LinkSpanDrawable.LinksTextView subtitleTextView;
    private ButtonWithCounterView button;

    public LockedChatsIntroductionCell(Context context, Theme.ResourcesProvider resourcesProvider, @NonNull Runnable linkCallback, Runnable buttonCallback) {
        super(context);

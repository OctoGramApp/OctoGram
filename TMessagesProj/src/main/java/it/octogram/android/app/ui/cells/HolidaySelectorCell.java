...
public class HolidaySelectorCell extends FrameLayout {
    ...
    public HolidaySelectorCell(Context context, int selectedDefault) {
        super(context);
        map = new HashMap<>();
        ...
        recyclerView.setOnItemClickListener((view, position) -> {
            MiniDrawerPreviewCell currItem = (MiniDrawerPreviewCell) view;
            ...
            for (int i = 0; i < recyclerView.getChildCount(); i++) {
                MiniDrawerPreviewCell child = (MiniDrawerPreviewCell) recyclerView.getChildAt(i);
                if (child != view) {
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private WeakReference<MiniDrawerPreviewCell> selectedViewRef;
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new RecyclerListView.Holder(new MiniDrawerPreviewCell(mContext));
        }

        @Override
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            MiniDrawerPreviewCell drawerCell2 = (MiniDrawerPreviewCell) holder.itemView;
        ...
        public void setSelectedItem(int position) {
            ...
            if (selectedItemPosition >= 0) {
                ...
                MiniDrawerPreviewCell view = selectedViewRef == null ? null : selectedViewRef.get();
                if (view != null) {

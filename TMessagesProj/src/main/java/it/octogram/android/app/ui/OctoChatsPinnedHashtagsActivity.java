 ...
 */
public class OctoChatsPinnedHashtagsActivity extends BaseFragment implements View.OnClickListener {
        ...
        try {
            ...
            for (int i = 0; i < object.length(); i++) {
                try {
                    ...
                    span.setOnClickListener(OctoChatsPinnedHashtagsActivity.this);
            ...
            if (!animationStarted) {
                ...
                if (currentAnimation != null) {
                    ...
                    if (containerHeight != resultHeight) {
                        animators.add(ObjectAnimator.ofInt(OctoChatsPinnedHashtagsActivity.this, "containerHeight", resultHeight));
                    }

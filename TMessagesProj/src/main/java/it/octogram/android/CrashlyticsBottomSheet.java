...
public class CrashlyticsBottomSheet extends BottomSheet {
    ...
    public CrashlyticsBottomSheet(BaseFragment fragment) {
        ...
        title.setText("OctoGram has stopped working! :(");
    ...
    public static void checkBottomSheet(BaseFragment fragment) {
        try {
            CrashlyticsBottomSheet dialog = new CrashlyticsBottomSheet(fragment);

...
public class OctoAiNewModelUI implements PreferencesEntry {
        ...
        return OctoPreferences.builder(getString(pageTitle))
                ...
                .category(getString(R.string.AiFeatures_CustomModels_Create_Details), category -> {
                    ...
                    category.row(new TextIconRow.TextIconRowBuilder()
                            .onClick(() -> {
                                IconSelectorAlert iconSelectorAlert = new IconSelectorAlert(context, true);
                                iconSelectorAlert.setOnItemClick(onItemClick -> {

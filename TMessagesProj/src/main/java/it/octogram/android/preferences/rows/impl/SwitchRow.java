...
public class SwitchRow extends BaseRow implements Clickable {
    ...
    private SwitchRow(@Nullable String title, @Nullable String summary, boolean requiresRestart, ConfigProperty<Boolean> showIf, boolean showIfReverse, boolean divider, ConfigProperty<Boolean> preferenceValue, Supplier<Boolean> supplierClickable, boolean premium, boolean autoShowPremiumAlert, int... posts) {
    ...
    public static class SwitchRowBuilder extends ToggleableBaseRowBuilder<SwitchRow, Boolean> {
        ...
        public SwitchRow build() {
            return new SwitchRow(title, description, requiresRestart, showIf, showIfReverse, divider, preferenceValue, supplierClickable, premium, autoShowPremiumAlert, postNotificationName);
        }
    }

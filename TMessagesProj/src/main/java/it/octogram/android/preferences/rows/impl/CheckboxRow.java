...
public class CheckboxRow extends BaseRow implements Clickable {
    ...
    private CheckboxRow(@Nullable String title, @Nullable String summary, boolean requiresRestart, ConfigProperty<Boolean> showIf, boolean showIfReverse, boolean divider, ConfigProperty<Boolean> preferenceValue, Supplier<Boolean> supplierClickable, boolean premium, boolean autoShowPremiumAlert, int... posts) {

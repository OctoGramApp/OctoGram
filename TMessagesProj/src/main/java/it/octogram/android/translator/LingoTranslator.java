...
public class LingoTranslator {
    ...
    public static void executeTranslation(String text, String toLanguage, SingleTranslationManager.OnTranslationResultCallback callback) {
        new Thread() {
            @Override
            public void run() {
                try {

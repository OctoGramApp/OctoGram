...
public class BlurIntensity extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + OctoConfig.blurIntensity, getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeBar.setProgress((OctoConfig.blurIntensity - startIntensity) / (float) (endIntensity - startIntensity));
    }
